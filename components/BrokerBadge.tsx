...
const PHONE_DISPLAY = "819 593-1768";
const PHONE_TEL = "+18195931768";
  ...
  return (
    <motion.a
      ...
      className="
        ...
        hover:shadow-[0_40px_100px_-30px_rgba(20,36,95,0.45)]
      "
      aria-label={`Appeler Vyncent Ledoux au ${PHONE_DISPLAY}`}
    >
      <div className="relative shrink-0">
        <div className="relative w-16 h-16 sm:w-20 sm:h-20 rounded-full overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200 ring-2 ring-white shadow-md">
          <Image
            src="/vyncent.png"
            alt="Vyncent Ledoux"
            fill
      ...
      <div className="shrink-0 flex flex-col items-center justify-center gap-0.5">
        <div className="
          ...
          shadow-[0_8px_22px_-6px_rgba(58,109,255,0.5)]
          group-hover:shadow-[0_12px_28px_-6px_rgba(58,109,255,0.65)]
          transition-shadow
        ">
